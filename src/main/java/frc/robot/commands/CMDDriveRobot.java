...
public class CMDDriveRobot extends CommandBase {
    ...
    private DoubleSupplier leftDriveStickX;
    private DoubleSupplier leftDriveStickY;
    private DoubleSupplier rightDriveStickX;
    private DoubleSupplier rightDriveStickY;
    ...
    public CMDDriveRobot(DoubleSupplier leftDriveStickXInput, DoubleSupplier leftDriveStickYInput, DoubleSupplier rightDriveStickXInput, DoubleSupplier rightDriveStickYInput, SUBDrivetrain subsystem) {

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=VARIABLE_SETTING
        leftDriveStickX = leftDriveStickXInput;
        leftDriveStickY = leftDriveStickYInput;
        rightDriveStickX = rightDriveStickXInput;
        rightDriveStickY = rightDriveStickYInput;
